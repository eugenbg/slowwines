...
<?php if ($this->is_create or $this->is_csv or $this->is_print){?>
        <div class="xcrud-top-actions">
            ...
            <?php echo $this->add_button('btn btn-success','glyphicon glyphicon-plus-sign'); echo "&nbsp;" . $this->render_search(); ?>
...
?>
        <div class="xcrud-top-actions">
			<a class="btn btn-success qres-action" data-task="create" href="javascript:;">
