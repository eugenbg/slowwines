<?php /** Configuration file; f0ska xCRUD v.1.6.24; 10/2014 */
class Xcrud_config
{
    // default connection
    public static $dbhost					= FS_DB_HOST;
    public static $dbname					= FS_DB_NAME;
    public static $dbuser					= FS_DB_USR;
    public static $dbpass					= FS_DB_PWD;
    ...
    public static $lang						= 'en'; // sets default localization
    ...
    // editor
    public static $editor_url				= '/inc/vndr/tinymce/tinymce.min.js'; // URL path to editor script, if you want to use the visual editor.
    public static $editor_init_url			= '/jx/initialise.editor.php'; //  URL path to your custom initialization file for editor.
    ...
    public static $upload_folder_def		= FS_FOLDER_DT_UPLD; // Default uploads folder on your site, relative to xCRUD folder or absolute path required. Folder is must exist.
