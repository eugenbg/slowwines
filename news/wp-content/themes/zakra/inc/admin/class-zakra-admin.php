...
class Zakra_Admin {
		...
		$config = array(
			...
			'support' => array(
				...
				'two' => array(
					...
					'button_link'  => 'https://themegrill.com/support-forum/',
					'is_button'    => false,
				),
	...
	public function admin_notice() {
		...
		if ( 'themes.php' == $pagenow && ! $notice_nag ) {
	...
	public static function hide_notices() {
		if ( isset( $_GET['zakra-hide-notice'] ) && isset( $_GET['_zakra_notice_nonce'] ) ) { // WPCS: input var ok.
			...
			// Hide.
			if ( $_GET['zakra-hide-notice'] === 'welcome' ) {
				update_option( 'zakra_admin_notice_' . $hide_notice, 1 );
			} else { // Show.
		...
		<div id="message" class="updated zakra-message">
			...
			<div class="zakra-message-wrapper">
				<div class="zakra-logo">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/inc/admin/images/zakra-dark-logo.png" alt="<?php esc_html_e( 'Zakra', 'zakra' ); ?>">
				</div>
				<p>
					<?php
					printf(
