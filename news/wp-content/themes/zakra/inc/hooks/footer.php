...
if ( ! function_exists( 'zakra_footer_bottom_bar_one' ) ) :
	...
	function zakra_footer_bottom_bar_one() {
		...
		$footer_bar_one = get_theme_mod( 'zakra_footer_bar_section_one', 'none' );
...
if ( ! function_exists( 'zakra_scroll_to_top' ) ) :
	...
	function zakra_scroll_to_top() {
		...
		<a href="" id="tg-scroll-to-top" class="tg-scroll-to-top">
			<i class="tg-icon <?php echo esc_attr( apply_filters( 'zakra_scroll_to_top_icon', 'tg-icon-arrow-up' ) ); ?>"><span
