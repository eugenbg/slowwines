...
= 1.0.2 =
* Escape issue of read more button fixed
* Sanitize issue of textarea fixed

= 1.0.1 =
* Related posts added
* Layout of page changed
* Responsive issue of search page fixed
...
== Images ==
Images used in screenshot are used from Pexels
