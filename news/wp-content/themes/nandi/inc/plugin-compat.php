...
add_action( 'after_setup_theme', 'nandi_setup_woocommerce' );
/**
 * Set up WooCommerce
 *
 */
function nandi_setup_woocommerce() {
	...
	add_action( 'woocommerce_sidebar', 'nandi_construct_sidebars' );
}

if ( ! function_exists( 'nandi_woocommerce_start' ) ) {
	add_action( 'woocommerce_before_main_content', 'nandi_woocommerce_start', 10 );
	/**
	 * Add WooCommerce starting wrappers
	 *
	 */
	function nandi_woocommerce_start() { ?>
...
if ( ! function_exists( 'nandi_woocommerce_end' ) ) {
	add_action( 'woocommerce_after_main_content', 'nandi_woocommerce_end', 10 );
	/**
	 * Add WooCommerce ending wrappers
	 *
	 */
	function nandi_woocommerce_end() { ?>
						</div><!-- .entry-content -->
						<?php
						/**
...
if ( ! function_exists( 'nandi_woocommerce_css' ) ) {
	add_action( 'wp_enqueue_scripts', 'nandi_woocommerce_css', 100 );
	/**
	 * Add WooCommerce CSS
	 *
	 */
	function nandi_woocommerce_css() {
		if ( ! class_exists( 'WooCommerce' ) ) {
			return;
		}

		$mobile = apply_filters( 'nandi_mobile_media_query', '(max-width:768px)' );
...
if ( ! function_exists( 'nandi_bbpress_css' ) ) {
	add_action( 'wp_enqueue_scripts', 'nandi_bbpress_css', 100 );
	/**
	 * Add bbPress CSS
	 *
	 */
	function nandi_bbpress_css() {
...
if ( ! function_exists( 'nandi_buddypress_css' ) ) {
	add_action( 'wp_enqueue_scripts', 'nandi_buddypress_css', 100 );
	/**
	 * Add BuddyPress CSS
	 *
	 */
	function nandi_buddypress_css() {
...
if ( ! function_exists( 'nandi_beaver_builder_css' ) ) {
	add_action( 'wp_enqueue_scripts', 'nandi_beaver_builder_css', 100 );
	/**
	 ...
	 *
	 */
	function nandi_beaver_builder_css() {
