...
if ( ! function_exists( 'nandi_social_bar' ) ) {
	add_action( 'nandi_social_bar_action', 'nandi_social_bar' );
	function nandi_social_bar() {
		$socials_facebook_url  		=  nandi_get_setting( 'socials_facebook_url' );
		$socials_twitter_url   		=  nandi_get_setting( 'socials_twitter_url' );
		$socials_google_url    		=  nandi_get_setting( 'socials_google_url' );
		$socials_tumblr_url    		=  nandi_get_setting( 'socials_tumblr_url' );
		$socials_pinterest_url 		=  nandi_get_setting( 'socials_pinterest_url' );
		$socials_youtube_url   		=  nandi_get_setting( 'socials_youtube_url' );
		$socials_linkedin_url  		=  nandi_get_setting( 'socials_linkedin_url' );
		$socials_custom_icon_1  	=  nandi_get_setting( 'socials_custom_icon_1' );
		$socials_custom_icon_url_1  =  nandi_get_setting( 'socials_custom_icon_url_1' );
		$socials_custom_icon_2  	=  nandi_get_setting( 'socials_custom_icon_2' );
		$socials_custom_icon_url_2  =  nandi_get_setting( 'socials_custom_icon_url_2' );
		$socials_custom_icon_3  	=  nandi_get_setting( 'socials_custom_icon_3' );
		$socials_custom_icon_url_3  =  nandi_get_setting( 'socials_custom_icon_url_3' );
		$socials_mail_url     		=  nandi_get_setting( 'socials_mail_url' );
	?>
    <div class="nandi-social-bar">
    	<ul class="nandi-socials-list">
