...
if ( ! function_exists( 'nandi_archive_title' ) ) {
	add_action( 'nandi_archive_title', 'nandi_archive_title' );
	/**
	 * Build the archive title
	 *
	 */
	function nandi_archive_title() { ?>
		<header class="page-header<?php if ( is_author() ) echo ' clearfix';?>">
			<?php
			/**
			 * nandi_before_archive_title hook.
			 *
			 */
			do_action( 'nandi_before_archive_title' );
			?>
			...
			<?php
			/**
			 * nandi_after_archive_title hook.
			 *
			 */
			do_action( 'nandi_after_archive_title' );
			...
			/**
			 * nandi_after_archive_description hook.
			 *
			 */
			do_action( 'nandi_after_archive_description' ); ?>
		</header><!-- .page-header -->
		<?php
	}
}

if ( ! function_exists( 'nandi_filter_the_archive_title' ) ) {
	add_filter( 'get_the_archive_title', 'nandi_filter_the_archive_title' );
	/**
	 ...
	 */
	function nandi_filter_the_archive_title( $title ) {
		if ( is_category() ) {
