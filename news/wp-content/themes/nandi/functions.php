...
define( 'NANDI_VERSION', '1.0.0' );

if ( ! function_exists( 'nandi_setup' ) ) {
	add_action( 'after_setup_theme', 'nandi_setup' );
	/**
	 * Sets up theme defaults and registers support for various WordPress features.
	 *
	 */
	function nandi_setup() {
		// Make theme available for translation.
		load_theme_textdomain( 'nandi' );
		...
		register_nav_menus( array(
			'primary' => __( 'Primary Menu', 'nandi' ),
		) );

		/**
		 * Set the content width to something large
		 * We set a more accurate width in nandi_smart_content_width()
		 */
...
define('NANDI_THEME_URL','https://wpkoi.com/nandi-wpkoi-wordpress-theme/','nandi');
define('NANDI_WPKOI_AUTHOR_URL','https://wpkoi.com/','nandi');
define('NANDI_WPKOI_SOCIAL_URL','https://www.facebook.com/wpkoithemes/','nandi');
define('NANDI_WORDPRESS_REVIEW','https://wordpress.org/support/theme/nandi/reviews/?filter=5','nandi');
define('NANDI_DOCUMENTATION','https://wpkoi.com/docs/','nandi');
