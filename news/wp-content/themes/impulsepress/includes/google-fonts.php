...
if ( ! function_exists('listgooglefontoptions') ) {
	function list_google_font_options() {
...
*/
if ( !function_exists('opt_load_google_fonts') ) {
	add_action('wp_head', 'opt_load_google_fonts');
	function opt_load_google_fonts() {
	
		$output_stylesheets = '';
		$output_css = '';
		
		// Body
		$body_font = impulse_press_options('body_gfont','default');
       
         
        
		if ( $body_font !== 'default' ) {
			$output_stylesheets .= "<link href='//fonts.googleapis.com/css?family=$body_font' rel='stylesheet' type='text/css'>";
			$output_css .= "body{font-family:'$body_font'; }";
            $output_css .= "h1,h2,h3,h4,h5,h6, .hp-highlight h3 {font-family:'$body_font'; }";
            $output_css .= ".navbar-brand {font-family:'$body_font'; }";
            $output_css .= ".navbar-nav > li > a, .dropdown-menu > li > a {font-family:'$body_font'; }";
		}
