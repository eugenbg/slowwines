...
if( !defined('ADMIN_PATH') )
	define( 'ADMIN_PATH', impulse_press_directory() . '/includes/admin/' );
if( !defined('OPTIONS_FILE_PATH') )
    define( 'OPTIONS_FILE_PATH', impulse_press_directory() . '/includes/options.php' );
if( !defined('ADMIN_DIR') )
	define( 'ADMIN_DIR', impulse_press_directory_uri() . '/includes/admin/' );
