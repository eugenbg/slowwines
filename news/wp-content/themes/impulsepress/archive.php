                        ...
                        <div class="post-entry">
                            ...
                            <div class="post-intro">
                                <h3 class="post-title"><a href="<?php the_permalink() ?>" rel="bookmark"
                                 ...
                                 <?php if( impulse_press_options('enable_disable_meta','1') == '1') {?>
                                    <div class="post-meta">
                                        <?php
                                             printf(__('<i class="fa fa-time"></i> %2$s <i class="fa fa-user"></i> %3$s', 'impulse-press'), 'meta-prep meta-prep-author',
                                ...
                                <div class="post-excerpt spacer10">
                                    <?php the_excerpt(); ?>
                                     <a href="<?php echo get_permalink(); ?>"><button type="button" class="readmore btn btn-default"><?php echo impulse_press_options('read_more_text','Read more...')?></button> </a>
                                 </div>
