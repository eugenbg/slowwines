...
= Gutenberg (WP5) and the end of the line =

Whilst the plugin does work with Gutenberg/WP5 the event editor is now a bit clunky. To integrate the plugin fully with WordPress 5 will take a lot of work and I just don't have the time. If you want the plugin let me know and we can do some negotiation.
