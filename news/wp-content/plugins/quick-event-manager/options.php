...
function qem_get_stored_register () {
    ...
    $default = array(
        'sort'          => 'field1,field2,field3,field4,field5,field6,field7,field8,field9,field10,field11,field12,field13,field14,field15',
        'useform'       => '',
        'formwidth'     => 280,
        'usename'       => 'checked',
        'usemail'       => 'checked',
        ...
        'errorblurb'    => __('Errors are marked', 'quick-event-manager'),
    ...
    if (!strpos($register['sort'],'field15')) $register['sort'] = $register['sort'].',field15';
    return $register;
}
...
function qem_get_stored_payment () {
    ...
    if ($payment['processtype'] ) {
        if ($payment['processtype'] == 'processfixed') $payment['processpercent'] = false;
        if ($payment['processtype'] == 'processpercent') $payment['processfixed'] = false;
    }
