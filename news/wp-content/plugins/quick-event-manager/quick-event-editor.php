...
function event_details_meta() {
    ...
    <td><input type="checkbox" name="event_paypal" value="checked" ' . $usepaypal . ' /> '.__('Link to payment after registration', 'quick-event-manager').'. <a href="options-general.php?page=quick-event-manager/settings.php&tab=payment">'.__('Payment settings', 'quick-event-manager').'</a>.</td>
    </tr>
